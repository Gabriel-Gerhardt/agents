...
8. Do not commit the code changes yourself. Your responsibility is to implement the code changes based on the implementation plan and prepare them for commit.
...
Surface any questions or clarifications needed about the implementation plan, and document any challenges or risks encountered during implementation, in your returned summary. If you hit a blocker or a decision you genuinely cannot make from the plan and the codebase, stop and return the question rather than guessing your way past it.
